...
M.refresh = function(_)
    ...
    if rc2 then
        ...
        vim.w.ws_enabled = {
            ...
            -- highlight blank lines at the beginning of a file
            vim.fn.matchadd(M.options.hl_name, "\\%^\\_s*\\n", M.options.hl_ws_prio),
            -- highlight blank lines at the end of a file
            vim.fn.matchadd(M.options.hl_name, "^\\_s*\\%$", M.options.hl_ws_prio),
            -- highlight adjacent blank lines, starting from 3rd
            vim.fn.matchadd(M.options.hl_name, reg, M.options.hl_ws_prio),
